...
#include <jni.h>
/* Header for class com_omar_deathnote_audioplay_SimpleLame */

#ifndef _Included_com_omar_deathnote_audioplay_SimpleLame
#define _Included_com_omar_deathnote_audioplay_SimpleLame
#ifdef __cplusplus
extern "C" {
#endif
/*
