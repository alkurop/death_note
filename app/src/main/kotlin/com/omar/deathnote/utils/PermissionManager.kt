...
class PermissionsManager {
    ...
    private fun showExplanation(permission: String, details: PermissionOptionalDetails) {
        AlertDialog.Builder(mContext).setTitle(details.title)
                  ...
                  .setPositiveButton(getString(R.string.dialog_ok)) { dialog, which -> makePermissionRequest(false) }
                  .setNegativeButton(getString(R.string.dialog_dismiss)) { dialog, which ->
    ...
    private fun showExplanationPermissionRequired(details: PermissionOptionalDetails) {
        AlertDialog.Builder(mContext).setTitle(details.title)
                  ...
                  .setPositiveButton(getString(R.string.dialog_ok)) { dialog, which -> startSettings() }
                  .setCancelable(false)
                  .show()
    }
    ...
    private fun log() {
        ...
        com.omar.deathnote.utils.log(TAG, stringBuilder.toString())
    }
}
